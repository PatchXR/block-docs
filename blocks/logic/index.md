...
- **[delay_jolt_2](./delay_jolt_2.md)** - 
- **[function](./function.md)** - Let you use math functions: sin, cos, tanh, floor, round, ceil, absolute, 1-x, sign, midi to freq...
...
- **[map_jolt](./map_jolt.md)** - Scales values from one range to another.
...
- **[route_reverse](./route_reverse.md)** - Combines N inputs into 1 output. An index can be given to filter which value will be passed to th...

...
- **[fork](./fork.md)** - Extension splitter cable, transmits one input stream to many outputs over a distance.
Click & dra...
- **[midi_control_change](./midi_control_change.md)** - Midi layer between PatchWorld and DAWs.
- **[midi_key](./midi_key.md)** - Midi layer between PatchWorld and DAWs.
- **[midi_keys](./midi_keys.md)** - Midi layer between PatchWorld and DAWs.
- **[msg_in](./msg_in.md)** - Receive an OSC message.
- **[msg_out](./msg_out.md)** - Send an OSC message.
...
- **[wireless_in_jolt](./wireless_in_jolt.md)** - Receives stream sent from the corresponding 'wireless_out_jolt' blocks. Each 'wireless_in_jolt' a...
- **[wireless_out](./wireless_out.md)** - Receives stream sent from the corresponding 'wireless_in' blocks. Each 'wireless_in' and 'wireles...

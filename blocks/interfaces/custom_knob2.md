...
![custom_knob2 thumbnail](https://portal.patchxr.io/block-thumbnails/custom_knob2.png)

## Description

Alternative-style knob that emits a jolt whenever its value changes. Click and drag up/down, or twist your hand while clicking, to change the value (default range 0 to 1).

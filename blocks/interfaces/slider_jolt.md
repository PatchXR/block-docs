...
A liner slider that can be used to control all sorts of stuff.
...
**Resize** *(Interactive)*: Drag to change length.

**Value** *(Interactive)*: Drag to change the value of the slider.
